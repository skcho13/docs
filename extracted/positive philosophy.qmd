...
the universe are explained by it, becaiise it connects under
one head the whole immensevariety of astronomical facts
;
...
that the two orders of j^henomena are identical ; which is
the point fi'om which the question set out. Again, M.
...
when theydisputedabout calorific matter andtheactionof
an universal ether. Intreating his subject in the Positive
method,hefindsinexhaustiblematerialforallhisactivityof
